        ...
        <tbody>
            @foreach ($siswa as $item)
                <tr>
                    ...
                    <td>
                        <a href="https://absen.smkn1gunungkijang.sch.id/gambar/siswa/{{$item->gambar->gambar}}" target="_blank" class="badge badge-info badge-btn py-1 border-0">Lihat Gambar</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
